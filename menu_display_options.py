class Auth_Menu:
    def auth_menu(self):
        menu = """
Welcome to "Finance Tracker Application" where you can Manage your Transactions,
Track your Budget and View Financial Reports.\n
Please select an option to login to the App.
====================
